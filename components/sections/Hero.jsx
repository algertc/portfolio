...
export default function Hero() {
    return (
        <section className="py-5 lg:py-6 md:py-15 xl:py-0 lg:pr-[3.2rem] xl:pb-24 xl:pr-[2rem] xxl:pr-[0rem]">
            <div className="container grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 items-center gap-4 md:gap-32 lg:gap-24 xl:gap-0 xxl:gap-[3rem]">
                {/* <div> */}
                <img
                    ...
                    height={560}
                    // quality={100}
                    className="sm:max-w-[320px] md:max-w-[450px] lg:max-w-[560px] xl:max-w-[62rem] xxl:max-w-[70rem] xxl:pb-32 xxl:ml-[24rem] mx-auto md:mx-0 lg:mx-auto xl:mx-10"
                />
                {/* </div> */}
                <div>
                    ...
                    <p className="max-w-none md:max-w-[350px] mx-5 lg:max-w-[560px] xl:max-w-[48rem] xxl:max-w-[51rem] md:ml-0.5 xl:ml-16 xxl:ml-11 lg:ml-2 md:mr-8 lg:mr-5 text-center md:text-left lg:text-left text-xl lg:text-3xl xl:text-[3.5rem] xxl:text-[3rem] font-mono font-bold lg:font-extrabold xl:leading-[4.1rem] xxl:leading-[4.4rem] xxl:pb-[12rem] leading-30">
