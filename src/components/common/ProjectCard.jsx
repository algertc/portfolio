export default function Card({ link, title, description, image }) {
  return (
    ...
    >
      <div class="group max-w-sm rounded-lg overflow-hidden shadow-lg hover:bg-gradient-to-r from-rose-400 via-m2-200 to-indigo-500 animate-gradient-x p-2 cursor-pointer scale-101 xxl:scale-[1.5] project-card">
