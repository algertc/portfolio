...
export default function Card({ link, title, description, image }) {
    return (
        ...
        >
            <div className="group max-w-sm rounded-lg overflow-hidden shadow-lg hover:bg-gradient-to-r from-rose-400 via-m2-200 to-indigo-500 animate-gradient-x p-2 cursor-pointer scale-101 xl:scale-[1.5] xxl:scale-[1.5] link-card mx-auto">
